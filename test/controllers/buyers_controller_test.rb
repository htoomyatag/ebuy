...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { buyer_address: @buyer.buyer_address, buyer_name: @buyer.buyer_name, buyer_phone: @buyer.buyer_phone, buyer_township: @buyer.buyer_township }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { buyer_address: @buyer.buyer_address, buyer_name: @buyer.buyer_name, buyer_phone: @buyer.buyer_phone, buyer_township: @buyer.buyer_township }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
