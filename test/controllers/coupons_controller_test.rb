...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { expire_date: @coupon.expire_date, limitation: @coupon.limitation, title: @coupon.title }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { expire_date: @coupon.expire_date, limitation: @coupon.limitation, title: @coupon.title }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
